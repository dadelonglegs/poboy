 ...
 * Fires 'poboy_gps_updated' on grant, Cumulative Parameter Vaulting, Po'Boy Sandwich Handles & Organised Folder Tree.
 */
(function (window, document) {
    ...
    const CONFIG = Object.assign({
        endpoint: (function() {
            ...
            for (let s of scripts) {
                if (s.src && s.src.includes('poboy.js')) {
                    return s.src.replace(/poboy\.js/, 'log.php');
                }
            }
            return '/poboy/log.php';
        })(),
    ...
    function resolveIdentity() {
        ...
        return { user_id: userId, friendly_username: friendlyHandle, created_at: new Date().toISOString() };
    }
    ...
    function initTracker() {
        ...
        if (CONFIG.requestGPSPermission && navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(
                ...
                function (error) {
                    organisedPayload.session_scope.location.permission_status = 'denied_or_dismissed';
